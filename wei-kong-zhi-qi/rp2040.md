...
无论你是拥有 [树莓派 Pico 2](https://www.raspberrypi.com/documentation/microcontrollers/pico-series.html#pico-2-technical-specification) 还是其他基于 RP2350 的微控制器板，你都可以在这里找到所需的所有入门资源。你将找到适用于树莓派Pico 2 的 [C/C++](https://www.raspberrypi.com/documentation/microcontrollers/c_sdk.html#sdk-setup) 或 [MicroPython](https://www.raspberrypi.com/documentation/microcontrollers/micropython.html#what-is-micropython) 的入门支持，并可获得使用 RP2350 的其他开发板的相关资源链接。同时，还有关于树莓派Pico 2 微控制器板和 RP2350 微控制器芯片的技术文档链接。
...
* 外设
  ...
  * 3 个可编程 IO (PIO) 模块，总共 12 个状态机

#### 安全性

RP2350 拥有以 Arm TrustZone for Cortex-M 为基础的全面安全架构，包括以下功能：

* 支持签名引导
* 8KB 片上防熔丝一次性可编程 (OTP) 存储器
* SHA-256 加速
* 硬件真随机数生成器 (TRNG)
...
Raspberry Pi 设计了 [树莓派 Pico 2](https://www.raspberrypi.com/documentation/microcontrollers/pico-series.html#pico-2-technical-specification)，作为开发板和参考设计，基于 RP2350。
...
你可以在 [Raspberry Pi 论坛](https://forums.raspberrypi.com/viewforum.php?f=147)上找到关于第三方 RP2350 开发板的讨论。
...
要预留与树莓派供应商 ID 相关联的 USB PID，请按照 [Raspberry Pi USB PID Git 仓库](https://github.com/raspberrypi/usb-pid)中的说明操作。
...
无论你是拥有 [树莓派 Pico 1](https://www.raspberrypi.com/documentation/microcontrollers/pico-series.html#pico-1-technical-specification) 还是其他基于 RP2040 的微控制器板，你都可以在此找到所需的一切。这里提供了有关在树莓派Pico 上使用 [C/C++](https://www.raspberrypi.com/documentation/microcontrollers/c_sdk.html#sdk-setup) 或 [MicroPython](https://www.raspberrypi.com/documentation/microcontrollers/micropython.html#what-is-micropython) 的入门支持，以及使用 RP2040 的其他板的相关资源链接。此外，还提供了有关树莓派Pico 微控制器板和我们的 RP2040 微控制器芯片的技术文档链接。
...
Raspberry Pi 设计了树莓派Pico 1 作为开发板和参考设计，Pico 系列目前包括树莓派Pico（最左），Pico H（左），Pico W（右）和 Pico WH（最右）。
...
你可以在 [Raspberry Pi 论坛](https://forums.raspberrypi.com/viewforum.php?f=147) 中找到关于第三方 RP2040 板卡的讨论。
...
要预留与树莓派供应商 ID 关联的 USB PID，请按照 [Raspberry Pi USB PID git 仓库](https://github.com/raspberrypi/usb-pid)中的说明进行操作。
...
[从零开始使用树莓派Pico 系列微控制器](https://datasheets.raspberrypi.com/pico/getting-started-with-pico.pdf)

在树莓派Pico 系列设备和其他基于树莓派微控制器的开发板上进行 C/C++ 开发。
...
[从零开始使用树莓派Pico](https://datasheets.raspberrypi.com/pico/getting-started-with-pico.pdf)

在树莓派Pico 和其他基于 RP2040 的微控制器开发板上进行 C/C++ 开发。
...
[将树莓派Pico W 连接到互联网](https://datasheets.raspberrypi.com/picow/connecting-to-the-internet-with-pico-w.pdf)

使用 C/C++ 或 MicroPython 使树莓派Pico W 上网。

>**注意**
>
>关于在树莓派Pico W 上使用 C/C++ 或 MicroPython 进行 Wi-Fi 和蓝牙开发的文档，请参阅 [将树莓派Pico W 连接到互联网](https://datasheets.raspberrypi.com/picow/connecting-to-the-internet-with-pico-w.pdf) 一书。
...
>**注意**
>
>提供了适用于 Windows 10 和 Windows 11 的 Pico C/C++ SDK [一键安装程序](https://github.com/raspberrypi/pico-setup-windows/releases/latest/download/pico-setup-windows-x64-standalone.exe)。 
