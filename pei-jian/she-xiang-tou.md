...
现在有几款官方的树莓派摄像头模块。最初的 500 万像素型号于 2013 年发布，随后于 2016 年发布了 800 万像素的摄像头模块 2。最新的摄像头型号是 1200 万像素的摄像头模块 3，于 2023 年发布。最初的 500 万像素设备已不再由树莓派提供。
...
>**注意**
>
>树莓派摄像头模块与所有具有 CSI 连接器的树莓派计算机兼容 - 也就是说，除了树莓派 400 和 旧版 Zero 之外的所有型号。 
...
>**警告**
>
>摄像头对静电很敏感。在处理 PCB 之前接地自己。如果没有接地带，水龙头或类似物品应该足够。
...
>**警告**
>
>该步骤无法逆转：连接滤镜的粘合剂在被揭起并更换后将无法存活，而红外滤镜约 1.1 毫米厚，在被移除时可能会破裂。移除它将使产品的保修失效。然而，对一些用户来说，移除滤镜是可取的。 
...
>**注意**
>
>可能很难或不可能将滤镜粘回原位，使设备恢复正常光学相机的功能。 
## 推荐镜头
...
从两个 10kΩ电阻器到 3.3V 和地（通过有效源阻抗为 5kΩ制造 1.65V）创建一个电位分压器。这可以连接到任一款树莓派。
...
>**警告**
>
>此修改包括移除一个 SMD 焊接部件。除非您觉得有能力完成此修改，否则请不要尝试。在焊接到摄像头板时，请移除塑料背盖以避免损坏。 
