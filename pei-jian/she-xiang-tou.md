...
现在有几款官方的树莓派摄像头模块。最初的 500 万像素型号于 2013 年发布，随后于 2016 年发布了 800 万像素的摄像头模块 2。最新的摄像头型号是 1200 万像素的摄像头模块 3，于 2023 年发布。最初的 500 万像素设备树莓派已经不再供应。
...
此外，分别于 2020 年和 2023 年发布了分别适用于外部镜头的 CS 或 M12 安装变种的 1200 万像素高质量摄像头。HQ 摄像头没有红外版本，但如果需要，也可以拆除红外滤镜。
...
>**注意**
>
>树莓派摄像头模块与所有具有 CSI 连接器的树莓派计算机兼容 - 也即除了树莓派 400 和 旧版 Zero 之外的所有型号。 
...
>**警告**
>
>摄像头对静电很敏感。在处理 PCB 之前请将自己接地。如果没有接地带，水龙头或类似物品应该也足够。

### 连接摄像头

将柔性电缆插入到树莓派上标有摄像头的连接器中，该连接器位于以太网口和 HDMI 口之间。电缆必须以银色接触面朝向 HDMI 口插入。要打开连接器，请将连接器顶部的标签向上拉，然后朝向以太网口。柔性电缆应牢固插入连接器中，注意不要使电缆以太锐角度弯曲。要关闭连接器，请将连接器顶部部分向 HDMI 口推下，同时保持电缆位置稳定。
...
* 在主电路板底部的两个 1.5 毫米六角锁定键上拧下。小心不要让垫圈滚开。在外壳和 PCB 之间有一层略带粘性的垫片，需要一点力气才能分开。
...
>**注意**
>
>可能很难或不可能将滤镜粘回原位，来使设备恢复正常光学相机的功能。 
