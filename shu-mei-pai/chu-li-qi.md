...
BCM2835 是在树莓派 1 型号 A、A+、B、B+、树莓派 Zero、树莓派 Zero W 和树莓派计算模块 1 中使用的博通（Broadcom）芯片。可以在外围规格文档中找到芯片的一些详细信息。它含有单核 ARM1176JZF-S 处理器。
...
是树莓派 2 Model B 中使用的博通芯片。BCM2836 中的底层架构与 BCM2835 相同。唯一显著的区别是删除了 ARM1176JZF-S 处理器，并用四核 Cortex-A7 集群替换。
...
是树莓派 3 Model B、树莓派 2 Model B 的后续型号以及树莓派计算模块 3 中使用的博通芯片。BCM2837 的底层架构与 BCM2836 相同。唯一显著的区别是用四核 ARM Cortex A53（ARMv8）集群替换了 ARMv7 四核集群。
