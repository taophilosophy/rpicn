...
由于内置节流功能，不用散热片也不会造成 SoC 过热损坏。不过，安装散热片和小型风扇可以缓解发热节流并提高性能。要获得最佳气流，并略微改善散热效果，可考虑将树莓派竖着放。
...
* 在 50°C 时，风扇慢速运行（30% 速度）
* 在 60°C 时，风扇速度提高至中速（50% 速度）
* 在 67.5°C 时，风扇速度提高至高速（70% 速度）
* 在 75°C 时，风扇速度达到全速（100% 速度）

温度下降时，使用相同的方式，并有 5°C 的滞后性；当温度下降到低于上述每个阈值 5°C 时，风扇速度才会降低。
