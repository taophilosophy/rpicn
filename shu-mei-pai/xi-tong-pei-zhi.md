...
如果你的树莓派型号支持，可以对 CPU 进行超频。超频能力因树莓派设备个体体质而异，即使是相同型号也会有所不同。超频过高可能会导致不稳定。
...
设置你的本地时区，从地区开始，然后选择一个城市，例如"Europe/London"。键入单个字母可跳转到列表中的该字母。

#### 键盘

将打开菜单，你可以在其中选择你的键盘布局。通常修改会立即生效，但可能需要重新启动。键入单个字母会跳转到列表中的该字母。
